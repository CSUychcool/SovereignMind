...
public:
    ...
    static void streamTts(const std::string& text, double lengthScale, Response& resp);
...
private:
    ...
    static std::string runCosyVoice(const std::string& sentence);   // sidecar GET /tts
    static std::string synthSentence(const std::string& sentence, double lengthScale); // cosy 优先, piper 兜底
